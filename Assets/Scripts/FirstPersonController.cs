...
// ** SETUP **
// Assign the FirstPersonController object to its own Layer
// Assign the Layer Mask to ignore the FirstPersonController object Layer
...
// alternatively : 
// at the end of this script is a Menu Item function to create and auto-configure a FirstPersonController object
// GameObject -> 3D Object -> FirstPersonController
...
public class FirstPersonController : MonoBehaviour
{
    ...
    public Transform cameraTx;                                 // Main Camera, as child of FirstPersonController object
    ...
    void Initialize()
    {
        if (!cameraTx) { Debug.LogError("* " + gameObject.name + ": FirstPersonController has NO CAMERA ASSIGNED in the Inspector *"); }
...
// this section adds create FirstPersonController object to the menu : New -> GameObject -> 3D Object
...
public class FirstPersonController_Setup : MonoBehaviour
{
    ...
    [MenuItem("GameObject/3D Object/FirstPersonController", false, 0)]
    public static void CreateFirstPersonController()
    {
        ...
        Debug.LogError("** SET the LAYER of the PLAYER Object, and the LAYERMASK of the FirstPersonController castingMask **");
        Debug.LogWarning(
            "Assign the FirstPersonController Player object to its own Layer, then assign the Layer Mask to ignore the FirstPersonController Player object Layer. Currently using layer "
        ...
        else // create example camera
        {
            ...
            GameObject camGo = new GameObject("FirstPersonController Camera");
